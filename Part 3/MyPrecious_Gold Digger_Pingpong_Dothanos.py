...
def do_turn(game):
    ...
    for my_iceberg in game.get_my_icebergs():
        ...
        elif game.get_enemy_icebergs() and game.turn % 11 != 0:
        ...
        if groups(my_iceberg,
            ...
            s = True
        elif (game.get_neutral_bonus_iceberg() and game.turn > 60 and
              groups(game.get_bonus_iceberg(),
                     game.get_my_penguin_groups()) < game.get_bonus_iceberg().penguin_amount) or (
                groups(game.get_bonus_iceberg(),
